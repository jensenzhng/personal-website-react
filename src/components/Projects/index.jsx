...
const ToysRUsBot = { "title": "ToysRUS Bot", "tech": "NodeJS", "description": "This is a script to automatically buy a product off of the ToysRUs website. I built this to both learn more about HTTP requests and also in hopes of getting a PS5 :)", "link": "/about/toysrus", "githubLink": ""};
...
const MarkovBot = { "title": "Markov Bot", "tech": "Backend NodeJS + Discord API", "description": "This Discord bot attempts that generates sentences (that sometimes make sense) based on previous messages in a Discord server.", "githubLink": "https://github.com/jensenzhng/markov-discord-bot", "link": "/about/markov"}
